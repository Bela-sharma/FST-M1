    ...
    public void testMethod() throws InterruptedException {
        ...
        for (int i=1;i<=rowcount.size();i++){
            ...
            if (driver.findElement(By.xpath("/html/body/div[4]/div/div["+(i+6)+"]")).getText().contains("Mobile")) {
                String mobileNumber = driver.findElement(By.xpath("/html/body/div[4]/div/div[" + (i + 6) + "]/div[2]/span")).getText();
                System.out.println("Mobile number displayed is: " + mobileNumber );
            }
            else{
